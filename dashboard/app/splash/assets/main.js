...
import {SetBreakpointsActiveParameterType as breakpoints} from "node/inspector";
...
(function ($) {
    ...
    if (settings.scrollZones.enabled)
        (function () {
            ...
            const $left = $('<div class="scrollZone left"></div>'),
                $right = $('<div class="scrollZone right"></div>'),
                $zones = $left.add($right);
            let paused = false,
                intervalId = null,
                direction;
            const activate = function (d) {
    ...
    $('.gallery')
        ...
        .prepend('<div class="modal" tabIndex="-1"><div class="inner"><img src="" alt="setup"/></div></div>')
        .find('img')
        .on('load', function () {
